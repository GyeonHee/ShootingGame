...
void GameLevel::Render()
{
	...
	if (isPlayerDead)
	{
		...
		Utils::SetCursorPosition(Vector2(playerDeadPosition.x, playerDeadPosition.y - 1));
		std::cout << "   .   ";

		Utils::SetCursorPosition(Vector2(playerDeadPosition.x, playerDeadPosition.y));
		std::cout << " .  .  .";

		Utils::SetCursorPosition(Vector2(playerDeadPosition.x, playerDeadPosition.y + 1));
		std::cout << "..:V:..";

		Utils::SetCursorPosition(Vector2(playerDeadPosition.x, playerDeadPosition.y + 2));
		std::cout << "Game Over!";
	...
	// 출력
	Utils::SetCursorPosition(Vector2(1, Engine::Get().Height() + 2));
